...
export default function ProductDetail({ product, isOpen, onClose, onEdit }: ProductDetailProps) {
  ...
  const materialColors: Record<string, string> = {
    CERAMIC: 'bg-amber-500/10 text-amber-400 border-amber-500/20',
    METAL: 'bg-gray-500/10 text-gray-400 border-gray-500/20',
    RUBBER: 'bg-green-500/10 text-green-400 border-green-500/20',
    'O-RING': 'bg-amber-500/10 text-amber-400 border-amber-500/20',
  }
      ...
      <div className="fixed inset-y-0 right-0 w-full max-w-2xl bg-stone-900 border-l border-stone-700 z-50 overflow-y-auto">
        ...
        <div className="sticky top-0 z-10 flex items-center justify-between bg-stone-900/95 backdrop-blur border-b border-stone-700 px-6 py-4">
          <div>
            ...
            <p className="text-sm text-stone-400 mt-1">
              Mã: <span className="font-mono text-amber-400">{product.partNumber}</span>
            </p>
          </div>
        ...
        <div className="p-6 space-y-6">
          ...
          <div className="rounded-xl bg-stone-800/50 border border-stone-700/50 p-6">
            ...
            <div className="grid grid-cols-2 gap-4">
              <div>
                ...
                <p className="font-mono text-lg font-semibold text-amber-400 tracking-wide mt-1">
                  {product.partNumber}
                </p>
              </div>
          ...
          <div className="rounded-xl bg-stone-800/50 border border-stone-700/50 p-6">
            ...
            <p className="text-stone-400 text-sm">Additional tabs - Coming soon</p>
          </div>
        </div>
      </div>
    </>
