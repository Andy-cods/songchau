          ...
          <div>
            ...
            <div className="flex items-center gap-2 mt-1.5">
              ...
              {deal.probability !== null && deal.probability !== undefined && (
                <span className="text-xs text-stone-400">{deal.probability}% xác suất</span>
              )}
            </div>
          </div>
        ...
        <div className="p-6 space-y-6">
          ...
          <div className="rounded-xl bg-stone-800/50 border border-stone-700/50 p-5">
            ...
            <div className="grid grid-cols-2 gap-4 text-sm">
              ...
              {deal.actualCloseDate && (
                <div>
                  <p className="text-xs text-stone-500">Ngày chốt thực tế</p>
                  <p className="text-green-400 mt-0.5">{format(new Date(deal.actualCloseDate), 'dd/MM/yyyy')}</p>
                </div>
              )}
              {deal.lostReason && (
                <div>
                  <p className="text-xs text-stone-500">Lý do lost</p>
          ...
          {deal.customerName && (
            <div className="rounded-xl bg-stone-800/50 border border-stone-700/50 p-5">
              ...
              <p
                className="text-sm font-medium text-amber-400 cursor-pointer hover:underline"
          ...
          {deal.quotationId && (
            <div className="rounded-xl bg-stone-800/50 border border-stone-700/50 p-5">
              ...
              <button
                ...
                className="text-sm font-mono text-amber-400 hover:underline"
              >
