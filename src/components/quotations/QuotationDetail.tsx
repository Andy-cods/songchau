    ...
    <>
      ...
      <div className="fixed inset-y-0 right-0 z-50 w-full max-w-2xl bg-white border-l border-stone-200 shadow-2xl overflow-y-auto slide-over-panel">
        ...
        {isLoading ? (
          ...
          <div className="py-20 text-center text-stone-500">Quotation not found</div>
        ) : (
          <div className="p-6 space-y-6">
            ...
            <div className="rounded-xl bg-stone-50 border border-stone-200 p-5">
              ...
              {quotation.customerPhone && (
                <p className="text-xs text-stone-400">{quotation.customerPhone}</p>
              )}
              {quotation.customerEmail && (
                <p className="text-xs text-stone-400">{quotation.customerEmail}</p>
              )}
            </div>
              ...
              <table className="w-full">
                <thead className="bg-stone-50">
                  <tr>
                    ...
                    <th className="px-4 py-2 text-right text-xs font-medium text-stone-500">Qty</th>
                    <th className="px-4 py-2 text-right text-xs font-medium text-stone-500">Unit Price</th>
                    <th className="px-4 py-2 text-right text-xs font-medium text-stone-500">Amount</th>
                  </tr>
                </thead>
