...
export default function Settings() {
  ...
  return (
    <div className="space-y-6">
      {/* Header */}
      <div>
        <h2 className="font-display text-2xl font-bold text-slate-50">Cài đặt</h2>
        <p className="text-sm text-slate-400 mt-1">Quản lý thông tin công ty và cài đặt hệ thống</p>
      </div>
      ...
      <div className="rounded-xl bg-slate-800/50 border border-slate-700/50 p-6 transition-all duration-200 hover:border-slate-700">
        <div className="flex items-center gap-3 mb-6">
          <div className="rounded-lg bg-blue-500/10 p-2">
            <Building2 className="h-5 w-5 text-blue-400" />
          </div>
          <div>
            <h3 className="font-display text-lg font-semibold text-slate-50">Thông tin công ty</h3>
            <p className="text-sm text-slate-400">Hiển thị trên báo giá và đơn hàng</p>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <div>
            ...
            <input
              ...
              className="w-full rounded-lg bg-slate-900 border border-slate-700 px-3 py-2 text-sm text-slate-200 focus:border-blue-500 focus:outline-none focus:ring-1 focus:ring-blue-500 transition-colors"
            />
          </div>
          ...
          <div>
            <label className="block text-sm font-medium text-slate-300 mb-2">Mã số thuế</label>
            <input
              type="text"
      ...
      <div className="rounded-xl bg-slate-800/50 border border-slate-700/50 p-6 transition-all duration-200 hover:border-slate-700">
        <div className="flex items-center gap-3 mb-6">
          ...
          <div>
            <h3 className="font-display text-lg font-semibold text-slate-50">Cài đặt tiền tệ</h3>
            <p className="text-sm text-slate-400">Tỷ giá hối đoái và tiền tệ mặc định</p>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          ...
          <div>
            <label className="block text-sm font-medium text-slate-300 mb-2">USD → VND</label>
            <input
              type="number"
          ...
          <div>
            <label className="block text-sm font-medium text-slate-300 mb-2">CNY → VND</label>
            <input
              type="number"
          ...
          <div>
            <label className="block text-sm font-medium text-slate-300 mb-2">JPY → VND</label>
            <input
              type="number"
      ...
      <div className="rounded-xl bg-slate-800/50 border border-slate-700/50 p-6 transition-all duration-200 hover:border-slate-700">
        <div className="flex items-center gap-3 mb-6">
          ...
          <div>
            ...
            <p className="text-sm text-slate-400">Cài đặt format cho báo giá, đơn hàng và thuế</p>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          ...
          <div>
            ...
            <input
              ...
              className="w-full rounded-lg bg-slate-900 border border-slate-700 px-3 py-2 text-sm text-slate-200 focus:border-blue-500 focus:outline-none focus:ring-1 focus:ring-blue-500 transition-colors"
            />
            <p className="text-xs text-slate-500 mt-1">Ví dụ: SC-Q-2026-0001</p>
          </div>
          ...
          <div>
            ...
            <input
              ...
              className="w-full rounded-lg bg-slate-900 border border-slate-700 px-3 py-2 text-sm text-slate-200 focus:border-blue-500 focus:outline-none focus:ring-1 focus:ring-blue-500 transition-colors"
            />
            <p className="text-xs text-slate-500 mt-1">Ví dụ: SC-PO-2026-0001</p>
          </div>
        </div>
      </div>
      ...
      <div className="rounded-xl bg-slate-800/50 border border-slate-700/50 p-6 transition-all duration-200 hover:border-slate-700">
        <div className="flex items-center gap-3 mb-6">
          ...
          <div>
            <h3 className="font-display text-lg font-semibold text-slate-50">Quản lý dữ liệu</h3>
            <p className="text-sm text-slate-400">Backup database</p>
          </div>
        </div>
