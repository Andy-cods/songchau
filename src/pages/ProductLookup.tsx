...
export default function ProductLookup() {
  ...
  const materialColors: Record<string, string> = {
    CERAMIC: 'bg-amber-500/10 text-amber-400 border-amber-500/30',
    METAL: 'bg-stone-500/10 text-stone-400 border-stone-500/30',
    RUBBER: 'bg-emerald-500/10 text-emerald-400 border-emerald-500/30',
    'O-RING': 'bg-amber-500/10 text-amber-400 border-amber-500/30',
  }

  const brandColors: Record<string, string> = {
    Panasonic: 'border-amber-500/50 hover:bg-amber-500/10',
    Fuji: 'border-amber-500/50 hover:bg-amber-500/10',
    Samsung: 'border-green-500/50 hover:bg-green-500/10',
    JUKI: 'border-orange-500/50 hover:bg-orange-500/10',
    Yamaha: 'border-stone-500/50 hover:bg-stone-500/10',
    Hitachi: 'border-amber-500/50 hover:bg-amber-500/10',
  ...
  return (
    <div className="max-w-5xl mx-auto">
      ...
      <div className="relative mb-8">
        <Search className="absolute left-4 top-1/2 -translate-y-1/2 h-6 w-6 text-stone-500" />
        <input
          type="text"
          value={searchInput}
      ...
      <div className="mb-4">
        <h3 className="text-xs font-medium text-stone-500 uppercase tracking-wider mb-2">Thương hiệu</h3>
      ...
      {/* Material Chips */}
      <div className="mb-6">
        <h3 className="text-xs font-medium text-stone-500 uppercase tracking-wider mb-2">Vật liệu</h3>
        <div className="flex gap-2 flex-wrap">
